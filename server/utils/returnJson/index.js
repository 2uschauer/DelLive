...
const RESULT = {
  ...
  SIGN_IN_FAIL: { resultCode: '930101', resultMsg: '用户登录失败' },
  SIGN_IN_USERNAME_OR_PASSWORD_FAIL: { resultCode: '930102', resultMsg: '用户名或密码错误' },
  SIGN_IN_VERIFY_CODE_EXPIRE: { resultCode: '930103', resultMsg: '验证码已过期' },
  SIGN_IN_LOCKED: { resultCode: '930107', resultMsg: '用户账号已锁定，请联系管理员解锁' },
